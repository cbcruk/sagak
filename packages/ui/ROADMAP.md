...
- [x] 커맨드 추상화 골격(`CommandRegistry`) + 위임 어댑터 (P0)
- [x] 정렬/블록 포맷 자체 구현 (P1)
- [x] 인라인 서식 엔진(토글/스타일/링크) (P2)
- [x] 리스트/들여쓰기 (P3)
- [x] `fontSize`·상태/값 조회·삽입 자체 구현 (P4)
- [x] 보류 서식 상태(stored marks) 도입 — collapsed 커서 경로 자체 구현
- [x] 레거시 어댑터 옵션화(`legacyFallback: false`) — 제거 대신 안전망 유지
